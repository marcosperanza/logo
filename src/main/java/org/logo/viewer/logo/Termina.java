...
/**
 * Rappresenta il comando TERMINA del linguagio LOGO
 * 
 * @author Marco Speranza
 * @version 0.2
 */
public class Termina extends AbstractStatement {

	/** Creates a new instance of Termina */
	public Termina() {
	}
	...
	public void execute() throws ProceduraTerminataException,
		...
		throw new ProceduraTerminataException();
	}
