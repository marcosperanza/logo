...
/**
 * Rappesenta il comando DESTRA del linguaggio LOGO
 * 
 * @author Marco Speranza
 * @version 0.2
 */
public class Destra extends AbstractStatement {

	/** Indica i gradi da girare */
	private Object gradi;

	/**
	 * Creates a new instance of Destra
	 * 
	 * @param gradi
	 *            Indica l'angolo che si deve fare
	 */
	public Destra(Object gradi) {
		this.gradi = gradi;
	}
