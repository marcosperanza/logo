...
/**
 * Rappesenta il comando PULISCI del linguaggio LOGO
 * 
 * @author Marco Speranza
 * @version 0.2
 */
public class Pulisci extends AbstractStatement {

	/** Creates a new instance of Pulisci */
	public Pulisci() {
		this.setName("Pulisci");
	}
	...
	public void execute() throws ProceduraTerminataException,
		...
		PrintMessage.printMessage("Pulisci");
